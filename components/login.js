...
export default function App() {
  return (
    ...
    <Text style={styles.subtitle1}>  Masuk untuk melanjutkan. </Text>
    <TextInput style={styles.input} placeholder="Email" />
    <TextInput style={styles.input} placeholder="Password"secureTextEntry caretHidden  />
    <Text style={styles.subtitle2}>  Lupa password? </Text>
      ...
      Belum punya akun?
      <Text style={styles.innerText}> Daftar Sekarang</Text>
    </Text>
    </View>
  );
}
